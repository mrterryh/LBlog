	...
	<div class="container">
		...
		<form class="form-horizontal" method="post">
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="input-title" placeholder="The name of your article" value="{{ Input::old('title') }}" required>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" id="input-slug" placeholder="The URL access point of your article" value="{{ Input::old('slug') }}" required>
				</div>
			</div>
